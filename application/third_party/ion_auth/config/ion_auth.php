...
$config['email_activation']           = false;               //todo true Email Activation for registration//todo my
$config['manual_activation']          = false;               //todo true Manual Activation for registration//todo my
